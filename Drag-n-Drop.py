...
if __name__ == "__main__":
    ...
    t2 = ToggledFrame(Root, text='Field', relief="raised", borderwidth=1)
    t2.pack(fill="x", expand=1, pady=2, padx=2, anchor="n",side=RIGHT)
    
    construct = ToggledFrame(Root, text='Construct', relief="raised", borderwidth=1)
    ...
    InitiationObjectStart.bind('<ButtonPress>',on_dnd_start)
    ...
    InitiationObjectFieldOne.bind('<ButtonPress>',on_dnd_start)
    ...
    InitiationObjectFieldTwo.bind('<ButtonPress>',on_dnd_start)
    ...
    InitiationObjectFieldFour.bind('<ButtonPress>',on_dnd_start)
    ...
    InitiationObjectFieldSixteen.bind('<ButtonPress>',on_dnd_start)
    ...
    InitiationObjectFieldVar.bind('<ButtonPress>',on_dnd_start)
    ...
    InitiationObjectPacket.bind('<ButtonPress>',on_dnd_start)
    ...
    InitiationObjectExpression.bind('<ButtonPress>',on_dnd_start)
    ...
    InitiationObjectConnector.bind('<ButtonPress>',on_dnd_start)
    ...
    InitiationObjectLess.bind('<ButtonPress>',on_dnd_start)
    ...
    InitiationObjectGtr.bind('<ButtonPress>',on_dnd_start)
    ...
    InitiationObjectLessEqual.bind('<ButtonPress>',on_dnd_start)
    ...
    InitiationObjectGreaterEqual.bind('<ButtonPress>',on_dnd_start)
    ...
    InitiationObjectEqual.bind('<ButtonPress>',on_dnd_start)
    ...
    InitiationObjectNand.bind('<ButtonPress>',on_dnd_start)
    ...
    InitiationObjectAndop.bind('<ButtonPress>',on_dnd_start)
    ...
    InitiationObjectOrop.bind('<ButtonPress>',on_dnd_start)
    ...
    InitiationObjectNotop.bind('<ButtonPress>',on_dnd_start)
    ...
    InitiationObjectOper.bind('<ButtonPress>',on_dnd_start)
    ...
    TargetWidget_TargetObject.pack()
